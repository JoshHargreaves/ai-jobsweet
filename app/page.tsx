            ...
            <div className="px-4">
              <div className="max-w-5xl mx-auto">
                ...
                <p className="sm:text-lg text-lg mt-6 text-slate-600">
                  JobSweet is committed to making AI accessible to everyone. We
                  believe that AI should not be limited to experts or those with
                  technical backgrounds. By providing user-friendly AI
                  generators, we strive to empower individuals from diverse
                  industries and skill sets to harness the benefits of AI in
                  their daily work.
                </p>
              </div>
            </div>
