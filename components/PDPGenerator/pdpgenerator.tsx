              ...
              <form>
                <div className="md:px-5 pb-5">
                  ...
                  <input
                    ...
                    hidden
                    type="number"
                    className=" text-black placeholder-gray-600 w-full px-4 py-2.5 mt-2 text-base   transition duration-500 ease-in-out transform border-transparent rounded-lg bg-white-100  border border-gray-300 rounded-md shadow-inner"
                  ></input>
                  <textarea
                    max-Length="2000"
                    required
                    onChange={(e) => {
                      setStrengths(e.currentTarget.value);
                    }}
                    placeholder="Strengths"
                    className="text-black w-full h-56 px-4 py-2.5 mt-2 text-s bg-white border border-gray-300 rounded-md shadow-inner md:h-240"
                    spellCheck="false"
                  ></textarea>
                  <textarea
                    max-Length="2000"
                    required
                    onChange={(e) => {
                      setWeaknesses(e.currentTarget.value);
                    }}
